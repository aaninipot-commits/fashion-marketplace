...
<section class="product spad">
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-lg-12">
                <form action="{{ route('shop.mens') }}" method="GET">
            ...
            <div class="col-lg-12">
                <div style="display:flex; gap:10px; flex-wrap:wrap;">
                    @foreach($categories as $category)
                        <a href="{{ route('shop.mens') }}?category={{ $category->id }}"
                            style="background:#f9f9f9; color:#666; padding:6px 16px; font-size:11px; font-weight:700; letter-spacing:1px; text-transform:uppercase; text-decoration:none; border:1px solid #eee;">
                            {{ $category->name }}
                        </a>
                    @endforeach
                </div>
        ...
        <div class="row">
            ...
            @empty
                <div class="col-lg-12 text-center" style="padding:60px 0;">
                    ...
                    <p style="font-size:16px; color:#999;">No men's products available yet.</p>
                </div>
            @endforelse
        </div>
