...
<head>
    ...
    <title>Reset Password | Fashion Marketplace</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .auth__subtitle { font-size: 14px; color: #999; margin-bottom: 35px; }
...
<body>
    <div class="auth__left">
        ...
        <div class="auth__left__text">
            <h2>Create <br> New <br> <span>Password.</span></h2>
            <p>Choose a strong password to keep your account secure.</p>
        </div>
    </div>
    <div class="auth__right">
        <div class="auth__brand">Account Recovery</div>
        <h1 class="auth__title">New Password</h1>
        <p class="auth__subtitle">Enter your new password below to complete the reset.</p>
