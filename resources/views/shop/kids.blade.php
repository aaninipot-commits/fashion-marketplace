...
<section class="product spad">
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-lg-12">
                <form action="{{ route('shop.kids') }}" method="GET">
        ...
        <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
                    <div class="product__item">
                        <div class="product__item__pic set-bg"
                            data-setbg="{{ $product->image ? asset('storage/' . $product->image) : asset('img/product/product-3.jpg') }}">
                            @if($product->stock <= 0)
            ...
            @empty
                <div class="col-lg-12 text-center" style="padding:60px 0;">
                    ...
                    <p style="font-size:16px; color:#999;">No kids' products available yet.</p>
                </div>
            @endforelse
        </div>
